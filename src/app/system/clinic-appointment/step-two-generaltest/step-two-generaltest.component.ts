...
@Component({
  selector: 'app-step-two-generaltest',
  templateUrl: './step-two-generaltest.component.html',
  styleUrls: ['./step-two-generaltest.component.scss']
})
export class StepTwoGeneraltestComponent implements OnInit {
